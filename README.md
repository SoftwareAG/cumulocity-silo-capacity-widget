# Cumulocity IoT Cylinder Fill widget[<img width="35" src="https://user-images.githubusercontent.com/67993842/97668428-f360cc80-1aa7-11eb-8801-da578bda4334.png"/>](https://github.com/SoftwareAG/cumulocity-image-animation-widget/releases/download/1.0.0/image-animation-widget.zip)


![Cylinder Fill example](./styles/previewImage.png)
...
**Configurable labels:** Add your own descriptions for the levels

**Optional Thresholds:** Set high, medium and low thresholds 

**Developer mode:** Use developer mode to perfectly position the background image, cylinder and foreground image
